    ...
    public partial class FormListaClientes : Form
    {
        ...
        private async void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                MessageBox.Show(persona.Nombres);
                ...
                frm.txtdireccion.Text = (string) dataGridView1.CurrentRow.Cells[3].Value ?? "" ;
                frm.txttelefono.Text = (string) dataGridView1.CurrentRow.Cells[4].Value ?? "";
